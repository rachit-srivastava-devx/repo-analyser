#!/usr/bin/env python3
"""Chronicle Analyzer CLI.

Usage:
    python3 cli.py analyze <target> [--out DIR] [--modules a,b,c] [--skip-slow]
...
from chronicle.util import discover_repos, write_json

MODULES = [
    "inventory", "ci_gates", "ontology", "effort", "escape", "churn", "complexity",
    "duplication", "exact_duplicates", "security", "depgraph", "testquality",
    "deps_audit", "lint_quality", "knowledge_graph",
    "synthesize", "deep_reports", "exec_deck", "pdf",
]
SLOW_MODULES = {"escape", "churn", "complexity", "duplication", "exact_duplicates", "security", "depgraph",
                 "testquality", "deps_audit", "lint_quality"}
...
def cmd_analyze(args: argparse.Namespace) -> int:
    ...
    from chronicle.report import render_report
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Chronicle Analyzer: multi-dimensional repo/portfolio analysis")
