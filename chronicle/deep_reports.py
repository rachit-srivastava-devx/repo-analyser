...
Total commits across the portfolio: **{total_commits}**. Median bus-factor Gini across all
repos: **{median_gini:.3f}**.
...
def architecture_report(data_dir: Path, charts_dir: Path, target_name: str) -> str:
    ...
    layer_table = _md_table(["Package", "Layer", "Why"],
                             [[l["name"], l["layer"], l["reason"]] for l in graph.get("layers", [])])
