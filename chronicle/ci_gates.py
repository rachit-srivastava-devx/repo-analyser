...
This exists because the Button/Chronicle engagement's own v1 pass got this
wrong for 27 repos (it looked for per-repo CI config in the wrong place and
concluded "no CI" for repos that had it centrally). The fix there was "go
read the actual CI config, don't infer it." This module does that directly:
